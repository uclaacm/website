...
export default [
  {
    ...
    internship: {
      whatWeDo: (
        <>
          With ACM being such a large organization, board serves to hold the
          club together. We plan club-wide events like general meeting in Fall
          and serve the committees by taking care of club-wide logistics
          <ul>
            <li>
              {' '}
            ...
            <li>
              {' '}
              External Affairs creates events between company affiliates and the
              general ACM community
            </li>
            <li> Finance handles finances within ACM at UCLA</li>
            <li>
              {' '}
              Alumni is responsible for creating alumni events and managing the
              alumni network to improve our current relations with past ACM at
              UCLA officers.
            </li>
            <li>
              {' '}
              Marketing handles social media platforms and communicate with
      ...
      whatInternsWillDo: (
        <ul>
          <li>
            {' '}
            Operations Interns will lead important all-ACM events such as Winter
            GM.{' '}
          </li>
          <li>
            {' '}
          ...
          <li>
            {' '}
            JEDI interns will organize events, work on projects and conduct
            culture survey.
          </li>
          <li>
            {' '}
            External Affairs interns will plan out events like company tours and
            info-sessions
          </li>
          <li>
            {' '}
            Finance interns will draft finance requests and secure funding for
            events
          </li>
          <li>
            {' '}
