...
export default [
  {
    ...
    infoCards: [
      {
        ...
        desc: (
          <>
            Each year, Studio splits into teams of students who work through the
            winter and spring quarters to put together an indie game. Students
            can apply to be team leads to pitch their idea to the club and have
            people join them to bring their game concept into reality! You can
            see past projects at{' '}
            <a href="https://acmstudio.itch.io/"> acmstudio.itch.io</a>
          </>
        ),
      },
      {
        ...
        desc: (
          <>
            No prior knowledge required! Studio offers the following workshop
            tracks: Introduction to Game Programming, Special Topics in Game
            Programming, and Creative Track. The Intro Track introduces students
            to the Unity editor. The Special Topics Track dives deep into
            specific game development areas officers are excited to share about.
            The Creative Track focuses on non-coding skills and how to
            incorporate them into a game project workflow. You can find tutorial
            content on our{' '}
            <a href="https://github.com/topics/acm-studio">GitHub</a>.
          </>
        ),
      },
      {
        ...
        desc: (
          <>
            Game jams are a beginner-friendly way to get right into making a
            game of your own! These game-focused hackathons typically span 48-72
            hours and revolve around a specific theme. Studio facilitates team
            formation for Ludum Dare (a global game jam) and also hosts in-house
            game jams such as our summer and winter break game jams.
          </>
        ),
      },
    ],
    ...
    internship: {
      whatWeDo:
        'Studio wants to create a community of game developers, whether you’re interested in gameplay programming, graphics, animation, pixel, music, whatever. We want to help you express yourself through video game development.',
      whatInternsWillDo: (
        <ul>
          <li>
            {' '}
            ACM Studio is looking for visual designers to learn ACM/ACM Studio
            style guide and create graphics to help market and promote our
            events on social media & update our branding on existing platforms!
            (Prior skills in graphic design / Figma are appreciated, but not
            required.)
          </li>
          <li>
            {' '}
            Intro to Game Programming Track is looking for people passionate
            about helping to create content for future beginner level workshops
            and to teach the content. Interns would be learning alongside
            experienced officers in the Fall and will have the opportunity in
            Winter to start actively working on / teaching workshops. (Prior
            skills in Unity / C# are appreciated, but not required.)
          </li>
          <li>
            {' '}
            Special Topics in Gaming is looking for people passionate about
            teaching more niche topics in game development (whether a specific
            game mechanic you seem to invest too much time in developing or that
            you’re deeply passionate about having good game programming
            practices). Interns will be learning alongside experienced officers
            in the Fall and will have the opportunity in Winter to start
            actively working on / teaching workshops. (Prior skills in Unity /
            C# are appreciated, but not required.)
          </li>
        </ul>
      ),
      card: '/images/cards/studio_card.svg',
      nextSteps:
        'After serving 2 quarters, interns will graduate and ACM Studio’s president(s) will conduct Intern Exit Interviews that will determine your officership in the spring.',
    },
  },
  {
    name: 'ICPC',
    ...
    internship: {
      whatWeDo:
        'ICPC spreads the joy of algorithmic problem solving - and helps you kick-start your career - through workshops, contests, and a top-ranked ICPC team!',
      whatInternsWillDo: (
        <>
          Interns will help produce and teach workshops in one of our two winter
          workshop tracks:
          <ul>
            <li>
              Intro to Competitive Programming (great for anyone interested in
              algorithms)
            </li>
            <li>
              Interview Track (best for people with interview and internship
              experience already).
            </li>
            <li>
              Advanced Competitive Programming workshop track (for people with a
              strong background in competitive programming, may or may not take
              interns)
            </li>
          </ul>
        </>
  ...
  },
  {
    ...
    internship: {
      whatWeDo:
        'Design aims to foster a community passionate about design and user experience through the intersection of creativity and technology. We focus on UX/UI design, graphic design, web development, and more!',
      whatInternsWillDo: (
        <ul>
          <li>
            {' '}
            All interns will learn ACM&apos;s branding and style and learn to
            use Figma
          </li>
          <li>
            {' '}
            Graphic design interns will create social media graphics for ACM
          </li>
          <li>
            {' '}
            UX design interns will design for our various internal projects
          </li>
        </ul>
      ),
  ...
  },
  {
    ...
    internship: {
      ...
      whatInternsWillDo: (
        <>
          ACM Cyber is currently not taking any interns. If you are interested
          in joining or becoming an active member in ACM Cyber, please check out{' '}
          {<a href="https://www.acmcyber.com/join">here</a>}.
        </>
      ),
      card: '/images/cards/cyber_card.svg',
      nextSteps:
        'All active members of ACM Cyber can apply to become officers in the Winter.',
    },
  },
  {
    name: 'Teach LA',
    ...
    internship: {
      whatWeDo:
        'Teach LA pairs UCLA students with schools in Los Angeles to provide free computer science classes. We have a teaching/curriculum team and a development team depending on what you’re interested in!',
      whatInternsWillDo: (
        <ul>
          <li>
            {' '}
            The Logistics and Outreach intern will reach out to schools and plan
            teaching schedules while working on instructor recruiting
          </li>
          <li>
            {' '}
            The JEDI intern will work with JEDI directors to help plan allyship
            spaces and train new instructors
          </li>
          <li>
            {' '}
            Speaker Series + Events Interns will be in charge of planning and
            putting on larger-scale events like Day of Code and coordinating
            smaller one-off events like speaker series
          </li>
          <li>
            {' '}
            Teaching Interns will either help School Leads with coordinating
            teaching with other instructors and reporting feedback, or serve as
            the point person for a class
          </li>
          <li>
            {' '}
            Curriculum Interns assist the Curriculum Director by working with
            School Leads and instructors to ensure that all of our curriculum is
            up-to-date and meets Teach LA’s standards.
          </li>
          <li>
            {' '}
            Dev Team Training interns will assist training directors in creating
            curriculum and training devs
          </li>
          <li>
            {' '}
            The Design intern will assist the Design Director in building
            hi-fidelity mockups of dev team projects, such as learning labs and
            the static site.
          </li>
        </ul>
      ),
      ...
      nextSteps:
        'Interns will have to apply for or receive an officer role post-internship, or will revert back to instructors or devs',
    },
  },
  {
    name: 'W',
    ...
    internship: {
      whatWeDo:
        'W is our committee focused on making tech a more diverse space! W does this through mentorship events, hosting career and networking panels, discussion spaces, and outreach events!',
      whatInternsWillDo: (
        <ul>
          <li> The Finance intern will manage and monitor the club budget</li>
          <li>
            {' '}
            The Outreach intern will co-ordinate with other large UCLA clubs to
            plan large diversity-focused events such as QWER Hacks and Day of
            Code
          </li>
          <li>
            {' '}
            The External intern will maintain contact with industry
            representatives and recruiters to plan for colab events
          </li>
        </ul>
      ),
  ...
  },
  {
    ...
    internship: {
      whatWeDo:
        'AI is about all things artificial intelligence and machine learning! We teach beginner-friendly and advanced workshops, run projects, and teach kids about machine learning :) ',
      whatInternsWillDo: (
        <ul>
          <li>
            {' '}
            The Outreach intern will teach weekly ML classes to high school
            students
          </li>
          <li>
            {' '}
            The Projects intern will guide people through building a deep
            learning model in PyTorch
          </li>
          <li>
            {' '}
            The Events intern will help create content, host and organize
            one-off or recurring events
          </li>
          <li>
            {' '}
            The Workshops interns will teach weekly ML and AI workshops to UCLA
            students
          </li>
        </ul>
      ),
      ...
      nextSteps:
        'All Interns have the opportunity to become officers in the Spring.',
    },
  },

  {
    ...
    infoCards: [
      {
        ...
        desc: (
          <>
            Our weekly Distributed File System Project series provided a
            hands-on introduction to distributed systems. Each week,
            participants explored concepts like cloud computing, system
            architectures, process communication, and security while building
            and enhancing a distributed file system. Starting with setting up a
            basic file server, they progressively implemented features such as
            client-server communication, naming services, consistency models,
            fault tolerance, and security measures. View the{' '}
            <a
      ...
      },
      {
        ...
        desc: (
          <>
            ...
            databases, serverless technologies, and infrastructure as code. The{' '}
            <a
            ...
            includes all code examples, slides, recordings, and guided project
            steps for you to get started with AWS.
          </>
        ),
      },
      {
        ...
        desc: (
          <>
            ...
            a comprehensive overview of GCP, featuring sessions on computing and
            databases with Google Cloud. View our GitHub repository{' '}
            <a
    ...
    internship: {
      ...
      whatInternsWillDo: (
        <>
          ACM Cloud is currently not taking any interns. If you are interested
          in joining or becoming an active member in ACM Cloud, please check out{' '}
          {
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSeeZzJ8dm_jqOj41DFRxMxTr1u7hVo7OEOPY_T1c2vggeZEjA/viewform">
              here
            </a>
          }
          .
  ...
  },
  {
    ...
    internship: {
      whatWeDo:
        'Hack is all about empowering the community with the means to build amazing things using software. We deal primarily with software development, most commonly web and mobile app development, and host events for these such as workshops and hackathons.',
      whatInternsWillDo:
        'Interns will work closely with the rest of the team to organize events, fulfilling roles (i.e. event  director, curriculum developer, marketing) chosen based on personal interest prior to each quarter. Interns may choose to additionally work on our internal dev team to maintain the Hack and HOTH websites.',
