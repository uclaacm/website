  ...
  testimonials: [
    {
      ...
      quote: (
        <>
          <h3 className={styles['testimonial-question']}>
          ...
          <span>
            Not much - I took AP CS in high school and didn’t learn a ton, and
            when I applied to be an intern I was taking CS 31.
          </span>
          <h3 className={styles['testimonial-question']}>
