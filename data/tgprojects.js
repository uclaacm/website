export default [
  {
    title: 'Covalent',
    names:
      "Arek Der-Sarkissian, Daniel Dai, Muthu Palaniappan, Will O'Brien, Hritik Arya, Catherine Hu, Daniel Lee, Michael Shi",
  ...
  },
  {
    ...
    summary:
      'Hotseat is an all-in-one course discovery website for UCLA students. With Hotseat, you can track courses and receive real-time notifications when seats open up, see grade distributions of previous sections, and see historical enrollment data in order to know which sections to use your first pass units on, among many other features.',
    category: 'Education',
  ...
  },
  {
    ...
    names: 'Haechan Song',
    summary:
      "Ever thought you were fine in a class until you actually calculated your grade and realized you're not? MyUCLA's gradebook doesn't give you a total score, so it's often hard to tell where you stand in the class. Bruin Score Check adds up all the scores in the \"Grades\" column to give you an unweighted, unofficial final grade.",
    category: 'Education',
  ...
  },
  {
    ...
    summary:
      'Compined is an online chatting tool that is both safe and easy to use. To promote a better chatting experience, Compined enables users to create and join chat rooms without signing-up, and all rooms created using this method are deleted after 24 hours for user protection.',
  ...
  },
  {
    ...
    summary:
      'We help organizations host more engaging, more authentic, and more meaningful group socials by pairing attendees based on personalities and common interests.',
    category: 'Social',
  ...
  },
  {
    ...
    names:
      'Emily Pitcher, Julia Lee, Elizabeth Han, Alan Guan, Richard Cheng, Wei Duong, Ray Hsiao, Hayden Nuyens',
    summary:
      'A visual novel video game about Asian American identity, love, mental health, and stargazing. In our game, the core gameplay loop is the player can connect stars in the sky to form custom constellations, which influence the story.',
  ...
  },
  {
    title: 'Spur',
    names:
      'Natalia Luzuriaga, Vishnupriya Bohra, Adithya Nair, Roshni Rao, Amit Bhatnagar',
    summary:
      "Spur is a student marketplace mobile app for students to get paid for what they know and get affordable help from the students around them for what they don't. Using the platform, students could save money by ordering services from other college students and make money by providing those services.",
  ...
  },
  {
    ...
    title: 'Wechews',
    names:
      'Hubert Chen, Kevin Tang, Francis Feng, Justin He, Hanna Co, Isha Gonuguntu',
    summary:
      'A Tinder-like app to help friends and family decide on a place to eat, overcoming our indecisiveness in a fun and easy way.',
    category: 'Gaming & Graphics',
