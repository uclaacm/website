    ...
    return (
      <div className="text-center">
        ...
        <div className="should-dim">
          <a href="https://docs.google.com/presentation/d/1Wc3wb5jIEo1FITf7CNAPqGTKY1swWOdG2EWsi6C5vXM/edit?usp=sharing" target="_blank" rel="noopener noreferrer">
        ...
        <div id="info-wrapper">
          ...
          <div className="flex">
            ...
            <div className="what-to-bring">
              ...
              <p> Fall GM will be hosted in the Grand Ballroom on the second floor of the Ackerman Union building. </p>
              <br></br>
              <h3>What to bring</h3>
        ...
        <div id="gm-program-wrapper">
          <h2>Program</h2>
            ...
            <div className="section-header">
              <h3>Welcome</h3>
              <p className="sub-heading">An introduction to ACM by our president Sujay.</p>
            </div>
					</div>
          <div className="gm-program-section">
            <div className="section-header">
            ...
            <p className="gm-program-row"><Image src= {hackLogo}  alt="ACM hack"/> James and Nathan</p>
					</div>
          <div className="gm-program-section">
            <div className="section-header">
              <h3>ACM Board</h3>
            ...
            <p className="gm-program-row"><Image src= {boardLogo} alt="ACM board"/>&nbsp;&nbsp;External: Eavan</p>
            <p className="gm-program-row"><Image src= {boardLogo} alt="ACM board"/>&nbsp;&nbsp;Internal: Advit</p>
          </div>
          <div className="gm-program-section">
            <div className="section-header">
