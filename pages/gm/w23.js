    ...
    return (
      <div className="text-center">
        ...
        <div className="should-dim">
          <a
            href="https://docs.google.com/presentation/d/1CQL-rhZ5dTKstzwSW6kDtngypM0nkxKwHCDrtJgVMRg/edit?usp=sharing"
            target="_blank"
        ...
        <div id="info-wrapper">
          ...
          <div className="flex">
            ...
            <div className="what-to-bring">
              ...
              <p>
                {' '}
                Winter GM will be hosted in the Grand Ballroom on the second
                floor of Ackerman Union building.{' '}
              </p>
              <br></br>
              <h3>What to bring</h3>
