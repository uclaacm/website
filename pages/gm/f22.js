  ...
  if (completed) {
    return (
      <div className="text-center">
        <h1>ACM&apos;s Fall GM 2022 happened on the 26th!</h1>
        <div className="should-dim">
          <a
            href="https://docs.google.com/presentation/d/1N_J_FSFWX7PGVCE8qwiRUvLJud4LYEA3SeS3pdaw5aE/edit?usp=sharing"
            target="_blank"
  ...
  return (
    <Layout>
      <NextSeo
        ...
        description="ACM's Fall General Meeting happened on September 26th at 6 PM PT!"
        openGraph={{
          images: [
            {
          ...
          <div className="gm-program-section">
            <div className="section-header">
              ...
              <p className="sub-heading">
                An introduction to ACM by our president Ava Asmani.
              </p>
            </div>
          </div>
          <div className="gm-program-section">
            ...
            <p className="gm-program-row">
              <Image src={studioLogo} alt="ACM studio" /> Caroline Wang, Ray
              Hsiao
            </p>
            <p className="gm-program-row">
              <Image src={icpcLogo} alt="ACM icpc" /> Robert Lee
            </p>
            <p className="gm-program-row">
              <Image src={designLogo} alt="ACM design" /> Muthu Palaniappan
            </p>
            <p className="gm-program-row">
              <Image src={cyberLogo} alt="ACM cyber" /> Jerry Xu, Stephen Kelman
            </p>
            <p className="gm-program-row">
              <Image src={teachlaLogo} alt="ACM teachLA" /> Jiin Kim, Milo
              Kearney
            </p>
            <p className="gm-program-row">
              <Image src={wLogo} alt="ACM w" /> Ethan Wong, Paige Brown
            </p>
            <p className="gm-program-row">
              <Image src={aiLogo} alt="ACM ai" /> Aman Oberoi
            </p>
            <p className="gm-program-row">
              <Image src={hackLogo} alt="ACM hack" /> Christina Tong, Nareh
              Agazaryan
            </p>
          </div>
          <div className="gm-program-section">
