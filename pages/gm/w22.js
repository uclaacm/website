...
const SLIDES_LINK =
  'https://docs.google.com/presentation/d/1XGyJdmuR78C9liEPlwqMq2PpNSaXS-PtlK15fvzQLRE/edit?usp=sharing';
const ZOOM_LINK =
  'https://ucla.zoom.us/j/92139691430?pwd=d0R0WkhuajlBS3NvNUJoUXdNWE9mQT09';
    ...
    <Layout>
      ...
      <div className="text-center">
        ...
        <img
          ...
          src="/images/Winter_GM_2022_graphic.png"
          width="1000px"
          alt="Winter GM 2022 Marketing Graphic"
        />
      </div>
            ...
            <div className="should-dim">
              ...
              >
                <div className="button-wrapper discord">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src="/images/DiscordLogoWordmark.png"
                    alt="Discord logo"
                    className="join-links-img"
                    width="200px"
                  />
        ...
        <div id="gm-program-wrapper">
          ...
          <div className="gm-program-section">
            <div className="section-header">
              ...
              <p className="sub-heading">
                {' '}
                Navigate to the Winter GM category on the{' '}
                <a
                  href="https://discord.gg/eWmzKsY"
                  target="_blank"
                  rel="noopener noreferrer"
