      ...
      <div id="info-wrapper">
        ...
        <div className="flex">
          ...
          <div className="what-to-bring">
            ...
            <span>(learn more about how ACM is <Link href={'/covid'} target="_blank" rel="noreferrer noopener">committed to running COVID-safe events</Link> in our return to campus)</span>
