    ...
    return (
      <div className="text-center">
        ...
        <div className="should-dim">
          <a href="https://docs.google.com/presentation/d/1fvtvkUuXqvYthfU0DZ0j3XDMzSkVoF_q9onnlWDwVZo/edit#slide=id.p" target="_blank" rel="noopener noreferrer">
	...
	return (
      ...
      <Countdown date={GM_START_TIME} renderer={countdownRenderer}/>
        ...
        <div id="info-wrapper">
          ...
          <p> Don&apos;t hesitate to contact us at acm@ucla.edu if you any accessiblity concerns for Winter GM.</p>
