		...
		<div className={styles.aboutPage}>
			...
			<div className={styles.contentSection}>
				...
				<div className={styles.textSection}>
					...
					<p>ACM is comprised of eight committees — each serving a different topic and mission. We strive to cover a plethora of interests and encourage members to explore new topics, too!</p>
				</div>
			</div>
			<div className={styles.contentSection}>
				<div className={`${styles.ornament} ${styles.imageOrnament} ${styles.imageOrnamentRight}`}>
				...
				<div className={styles.textSection}>
					...
					<p>No matter what your background or major is, we would love to have you at our events and activities!</p>
					<p>To keep up with what&rsquo;s happening, we recommend joining <a href="https://members.uclaacm.com" target="_blank" rel="noreferrer noopener">our membership portal</a>, <a href="https://www.facebook.com/groups/uclaacm" target="_blank" rel="noreferrer noopener">our Facebook group</a>, and <a href="http://eepurl.com/c5pE6P" target="_blank" rel="noreferrer noopener">our weekly newsletter</a>. We will keep you up to date with everything ACM, and earning points on the portal might even earn you a prize!</p>
