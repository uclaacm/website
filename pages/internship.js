    ...
    return(
        <Layout>
            ...
            <div className={'content-section text-center'}>
                ...
                <h2>Applications for the ACM Internship Program are now live. <br></br><a href="http://tinyurl.com/ACM-W24-apps" target="_blank" rel="noopener noreferrer">Apply Now </a></h2>
                <br></br>
