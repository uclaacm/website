...
import TownHallBanner from '../../public/images/town-hall/town-hall-banner-s23.png';
...
function TownHall() {
  ...
  return (
    <Layout>
      <NextSeo
        title="Spring 2023 Computer Science Town Hall | ACM at UCLA"
        description="Ask questions and get your voice heard at the Spring 2023 Computer Science Town Hall! Wednesday, November 9th from 6:00 - 8:00 PM PT - we hope to see you there :)"
        openGraph={{
          images: [
            {
              ...
              width: 1920,
              height: 1005,
              alt: "A banner that reads 'Spring 2023 Computer Science Town Hall: ask questions and be heard! Wednesday, November 9th from 6:00 - 8:00 PM PT. Mong Learning Center, Engineering VI. Ask Questions and get your voice heard!'",
            },
          ],
      ...
      <div className="content-container-tight">
        <div className="text-center">
          <Image
            src={TownHallBanner}
            alt="A banner that reads 'Spring 2023 Computer Science Town Hall: ask questions and get your voice heard! Wednesday, November 9th from 6:00 - 8:00 PM PT. Mong Learning Center, Engineering VI. Ask Questions and get your voice heard!'"
          />
          <h1>Spring 2023 Computer Science Town Hall</h1>
        </div>
        <p>
        ...
        <p>
          The Spring Town Hall will take place on <b>Wednesday, May 10th</b> (Week 6)
          at <b>6:00 - 8:00 PM PT</b> in the Mong Learning Center (in Engineering VI).
        </p>
        ...
        <ul className="list-unstyled text-center">
          <li style={inlineButtonListStyle}>
            <Link
              href="https://forms.gle/hqUvhJztX3P4fMtE8"
              className="button"
              target = "_blank">
      ...
      <div className="content-container-medium">
        <div className="grid-tablet-2">
          <div>
            ...
            <Link
              href="https://forms.gle/L2Z1hE1CNeNcWTfe6"
              className="button"
              target="_blank"
        ...
        <div className="grid-tablet-2">
          <div>
            ...
            <ul className="list-unstyled">
              <li style={inlineButtonListStyle}>
                <Link
                  href="https://docs.google.com/presentation/d/14MIk1bzHHr5b11cgYX_kAz5WQa6ToKD_9nnj3_5DLco/edit?usp=sharing"
                  className="button"
                  target="_blank"
                  rel="noopener noreferrer">
              ...
              <li style={inlineButtonListStyle}>
                <Link
                  href="https://docs.google.com/document/d/1JTFaP27OsqA0sBhjbIC4mIzjCgqRLJyBxvOQ5FSrPCk/edit?usp=sharing"
                  className="button"
                  target="_blank"
                  rel="noopener noreferrer">
        ...
        <div className="grid-tablet-2">
          <div>
            ...
            <ul className="list-unstyled">
              <li style={inlineButtonListStyle}>
                <Link
                  href="https://docs.google.com/presentation/d/1L9dSMVUr1TSazZu0-LqSHRSjEMMOO4GG-kZlOrkAjOM/edit?usp=sharing"
                  className="button"
                  target="_blank"
                  rel="noopener noreferrer">
              ...
              <li style={inlineButtonListStyle}>
                <Link
                  href="https://docs.google.com/document/d/1QADyPwSqwf4cS_O51klvqA8dAcNlOXF1zT5YThi78q4/edit?usp=sharing"
                  className="button"
                  target="_blank"
                  rel="noopener noreferrer">
        ...
        <div className="grid-tablet-2">
          <div>
            ...
            <ul className="list-unstyled">
              <li style={inlineButtonListStyle}>
                <Link
                  href="/files/town-hall/CS Town Hall Fall 2021 Slides.pdf"
                  className="button"
                  target="_blank"
                  rel="noopener noreferrer">
              ...
              <li style={inlineButtonListStyle}>
                <Link
                  href="/files/town-hall/CS Town Hall Fall 2021 Notes.pdf"
                  className="button"
                  target="_blank"
                  rel="noopener noreferrer">
