  ...
  const embedWidth = embed2021WRef.current ? embed2021WRef.current.offsetWidth : 500;
	return (
      <CountdownElement switchTime={TEST_START_TIMESTAMP} fallback={<span>come back soon :)</span>}>
          ...
          <p>
            {/* eslint-disable-next-line max-len */}
            The upcoming Town Hall occurs on <b>Wednesday, November 10th</b> (Week 7) at <b>6:30 - 8:30 PM PT</b>. The event will be hybrid: an in-person offering will be in the Mong Auditorium (in Engineering VI), while a livestreamed option with an online Q&amp;A will also be available. To attend, <Link href="https://bit.ly/CSTownHallFall2021RSVP" target="_blank" rel="noopener noreferrer">please RSVP!</Link>
          </p>
          <p>
            {/* eslint-disable-next-line max-len */}
          ...
          <ul className="list-unstyled text-center">
            <li style={inlineButtonListStyle}>
              <Link
                href="https://bit.ly/CSTownHallFall2021RSVP"
                className="button"
                target="_blank"
                rel="noopener noreferrer"><FontAwesomeIcon icon={faCalendarCheck} fixedWidth aria-hidden={true} />RSVP now!</Link>
            </li>
            {' '}
            <li style={inlineButtonListStyle}>
              <Link href="#surveys" className="button"><FontAwesomeIcon icon={faFileAlt} fixedWidth aria-hidden={true} />Answer Survey Questions!</Link>
            </li>
            {' '}
            <li style={inlineButtonListStyle}>
              <Link
                href="https://app.sli.do/event/jcaoo1z7"
                className="button"
                target="_blank"
                rel="noopener noreferrer"><FontAwesomeIcon icon={faQuestion} fixedWidth aria-hidden={true} />Ask questions in advance!</Link>
            </li>
            {' '}
            <li style={inlineButtonListStyle}>
              <Link
                href="https://docs.google.com/presentation/d/1IDtHk52HApxHTigT9aAXf0-fZNeYUQ9F9MYfHBybBNs/edit?usp=sharing"
                className="button"
                target="_blank"
                rel="noopener noreferrer"><FontAwesomeIcon icon={faFilePowerpoint} fixedWidth aria-hidden={true} />Event Slides</Link>
            </li>
          </ul>
          <hr />
        </div>
          ...
          <div className="grid-tablet-2">
            <div>
              ...
              <ul className="list-unstyled">
                <li style={inlineButtonListStyle}>
                  <Link
                    href="https://bit.ly/CSTownHallFall2021Curriculum"
                    className="button"
                    target="_blank"
                    rel="noopener noreferrer"><FontAwesomeIcon icon={faFileAlt} fixedWidth aria-hidden={true} />Academics and Curriculum</Link>
                </li>
                {' '}
                <li style={inlineButtonListStyle}>
                  <Link
                    href="https://bit.ly/CSTownHallFall2021Diversity"
                    className="button"
                    target="_blank"
                    rel="noopener noreferrer"><FontAwesomeIcon icon={faFileAlt} fixedWidth aria-hidden={true} />Diversity and Inclusion</Link>
                </li>
                {' '}
                <li style={inlineButtonListStyle}>
                  <Link
                    href="https://bit.ly/CSTownHallFall2021Honesty"
                    className="button"
                    target="_blank"
                    rel="noopener noreferrer"><FontAwesomeIcon icon={faFileAlt} fixedWidth aria-hidden={true} />Academic Honesty</Link>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="list-unstyled">
                <li style={inlineButtonListStyle}>
                  <Link
                    ...
                    className="button"
                    target="_blank"
                    rel="noopener noreferrer"><FontAwesomeIcon icon={faFileAlt} fixedWidth aria-hidden={true} />Form Summaries and Slides</Link>
                </li>
                {' '}
                <li style={inlineButtonListStyle}>
                  <Link
                    ...
                    className="button"
                    target="_blank"
                    rel="noopener noreferrer"><FontAwesomeIcon icon={faFileAlt} fixedWidth aria-hidden={true} />Event Notes</Link>
                </li>
              </ul>
            </div>
