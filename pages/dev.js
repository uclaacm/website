...
function DevTeam() {
  const devTeamOfficers = data.filter(
    (officer) =>
    ...
    <Layout>
      ...
      <div className={'content-section text-center'}>
        ...
        <p className={styles['dev-team-info']}>
          ...
          The ACM Dev Team handles general internal development needs for all of
          ACM at UCLA. We maintain and create organization-wide projects such as
          the website, Discord bot, Membership Portal, and link shortener.
        </p>
        <p className={styles['dev-team-info']}>
        ...
        <p className={styles['project-info']}>
          ...
          ! In the spirit of open-source, anyone is welcome to view and
          contribute to our projects on&nbsp;
