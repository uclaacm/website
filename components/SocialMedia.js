...
function SocialMedia(props){
	...
	return (
		<span className={`${styles.socialMediaIconContainer} ${styles[iconType]}`}>
            ...
            <a className={styles.iconLink} href="https://www.github.com/uclaacm" target="_blank" rel="noreferrer noopener" aria-label="ACM at UCLA on GitHub">
                <FontAwesomeIcon icon={faGithub} fixedWidth aria-hidden={true} />
            </a>
            <a className={styles.iconLink} href="https://www.instagram.com/acm.ucla/" target="_blank" rel="noreferrer noopener" aria-label="ACM at UCLA on Instagram">
                <FontAwesomeIcon icon={faInstagram} fixedWidth aria-hidden={true} />
            </a>
            <a className={styles.iconLink} href="https://discord.gg/eWmzKsY" target="_blank" rel="noreferrer noopener" aria-label="ACM at UCLA on Discord">
                <FontAwesomeIcon icon={faDiscord} fixedWidth aria-hidden={true} />
            </a>
            <a className={styles.iconLink} href="https://www.youtube.com/c/acmucla" target="_blank" rel="noreferrer noopener" aria-label="ACM at UCLA on YouTube">
                <FontAwesomeIcon icon={faYoutube} fixedWidth aria-hidden={true} />
            </a>
            <a className={styles.iconLink} href="https://medium.com/techatucla" target="_blank" rel="noreferrer noopener" aria-label="ACM at UCLA on Medium">
