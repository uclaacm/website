...
function SocialMedia(props){
	return (
		<React.Fragment>
            ...
            <a href="https://www.youtube.com/channel/UCwTqwgA4thysNbB2kNYsCIw" target="_blank" rel="noreferrer noopener"><div className={'sm-icon ' + props.type} id="youtube" style={{width: 35 + 'px'}} /></a>
