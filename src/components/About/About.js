			...
			<div className="about-page">
				...
				<div className="content-section">
					...
					<div className="text-section">
						<h1>What is ACM?</h1>
						<p className="half-size">As a student chapter of the international <a href="https://www.acm.org" target="_BLANK">Association for Computing Machinery,</a> ACM at UCLA is the largest Computer Science student organization at UCLA and in Southern California. We welcome students of all different backgrounds and skill levels to join our community and share in our passion for CS!</p>
				...
				<div className="content-section left">
					...
					<div className="text-section">
						...
						<p className="half-size">To become a member and keep up with upcoming events, you should join <a href="https://members.uclaacm.com" target="_BLANK">our membership portal</a>, follow <a href="https://www.facebook.com/groups/uclaacm" target="_BLANK">our Facebook group</a>, and sign up for <a href="http://eepurl.com/c5pE6P" target="_BLANK">our weekly newsletter</a>. Signing up will keep you up to date with everything ACM, and earning points on the portal might even earn you a prize!</p>
					</div>
				</div>
