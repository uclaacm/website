export default [
	...
	{
		title: 'ACM establishes Hack School',
		date: 'March 4, 2010',
		description: 'Ac auctor augue mauris augue neque gravida in. Rhoncus dolor purus non enim praesent elementum. Suspendisse interdum consectetur libero id faucibus nisl tincidunt eget. Arcu vitae elementum curabitur vitae nunc sed velit. At risus viverra adipiscing at in tellus integer. Egestas quis ipsum suspendisse ultrices gravida. Sollicitudin tempor id eu nisl. Ultricies mi quis hendrerit dolor magna eget est lorem. Mi ipsum faucibus vitae aliquet nec. Fames ac turpis egestas integer eget aliquet. Lorem dolor sed viverra ipsum nunc aliquet bibendum enim facilisis. Id nibh tortor id aliquet lectus proin nibh nisl condimentum. Habitant morbi tristique senectus et netus et. Erat pellentesque adipiscing commodo elit. Vel elit scelerisque mauris pellentesque pulvinar pellentesque habitant. Vitae et leo duis ut diam quam nulla porttitor. Pretium aenean pharetra magna ac placerat vestibulum lectus. Duis tristique sollicitudin nibh sit amet. A diam sollicitudin tempor id eu nisl nunc. Dui vivamus arcu felis bibendum ut tristique et egestas.',
	},
	{
		title: 'ACM grows to over 1,000 members',
		date: 'August 25, 2001',
