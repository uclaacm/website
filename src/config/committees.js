    ...
    infoCards: [
      {
        ...
        desc:
          "From climbing coding leaderboards to competing in ICPC regionals to constructing clever algorithms with clever friends, the Competitive Programming journey starts here. Write your first contest solution and learn what it takes to start solving challenging and often beautiful problems!",
      },
      {
        ...
        desc:
          "An advanced workshop to help learn and practice advanced algorithms, data structures, and problem solving skills. Focus of the workshop will be preparing for the ICPC competition, but the workshop is open to anyone interested!",
      },
      {
        title: "CodeSprintLA",
        image: {
      ...
      },
      {
        ...
        desc:
          "Ace this recruiting season with focused interview prep from ACM ICPC. In our weekly series, we will cover all the essentials from stacks and queues to string manipulation and dynamic programming.",
      },
    ],
  ...
  },
  {
    ...
    infoCards: [
      ...
      },
      {
        ...
        desc:
          "Come join ACM Design for our second UIUX workshop: User Experience Research 💡 Learn about building a user flow map 🗺, user testing 📝, user personas 👤, and much more! Although this is the second workshop in our series, we encourage you to come out even if you missed the first one!",
      },
      {
  ...
  },
  {
    ...
    infoCards: [
      ...
      },
      {
        ...
        desc:
          "Collaborate with your friends in our beginner friendly Capture The Flag (CTF) competition. Challenges will be targeted at the skills that you’ve learned from our Winter workshops. Top teams get bragging rights as well as prizes.",
      },
    ],
    ...
    infoCards: [
      ...
      },
      {
        ...
        image: {
          ...
          alt:
            "Eight ACM W members on Zoom conference call forming a collective heart with their arms.",
        },
        desc: "",
      },
      {
    ...
    infoCards: [
      {
        ...
        desc:
          "Hack Sprint is our beginner-friendly workshop series on mobile development with React Native. Through React Native, you'll be able to build apps for both Android and iOS devices at the same time! You’ll also get to build and present your very own app in our final showcase. No previous mobile development experience is needed!",
      },
      {
        ...
        desc:
          "Hack off the Hill (HOTH 8) is the virtual edition of our annual hackathon. This 2-day long beginner-friendly hackathon is designed to give you a glimpse of a real hackathon. There will be workshops, mentors, and fun prizes for the best hacks!",
      },
      {
        title: "Hack Fam",
        image: {
        ...
        desc:
          "Join one of our families to meet new people and find a close support group to hang out with, study with, and form long lasting friendships for life with.",
      },
    ],
